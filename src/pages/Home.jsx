...
const Home = () => {
  ...
  <div>
    ...
    <section id="team" className="relative h-[130vh] bg-gray-100 flex flex-row items-center">
      ...
      <div
            className="absolute top-0 right-auto left-[50%] w-36 h-36 border-4 border-green-300 bg-cover bg-center rounded-full animate-customAnimationIn"
            style={{
      ...
      <div className="relative w-[100%] h-[100%] flex flex-col items-center justify-center">
        <div className="absolute h-full flex flex-col justify-center items-center -translate-x-1/4">
          <div
              className="w-80 h-80 bg-cover bg-center rounded-full -translate-x-3/4"
              style={{
                backgroundImage: `url(${womenImage})`,
              }}
            ></div>
            <div
              className="w-[432px] h-[432px] bg-cover bg-center rounded-full -translate-y-1/4"
              style={{
                backgroundImage: `url(${womenImage})`,
            ...
            ></div>
            <div
              className="w-80 h-80 bg-cover bg-center rounded-full  -translate-y-2/3 -translate-x-2/3"
              style={{
                backgroundImage: `url(${womenImage})`,
        ...
        <div className="absolute z-10 bg-black text-white rounded-lg p-6 shadow-lg max-w-lg text-center translate-x-1/4 translate-y-1/2">
